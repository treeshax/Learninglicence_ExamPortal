...
export type ViolationType='FACE_MISSING'|'MULTIPLE_FACES'|'LOOKING_AWAY'|'AUDIO_DETECTED'|'SUSTAINED_SPEECH'|'FULLSCREEN_EXIT'|'SCREEN_SHARE_STOPPED'|'SCREEN_SHARE_CHANGED'|'INVALID_SCREEN_SHARE'|'TAB_SWITCH'|'WINDOW_BLUR'|'MAX_WARNINGS_REACHED';
export const STRICT_PROCTORING=true;
export const STRICT_FULLSCREEN=true;
const critical=new Set<ViolationType>(['FULLSCREEN_EXIT','MULTIPLE_FACES','SCREEN_SHARE_STOPPED','SCREEN_SHARE_CHANGED','INVALID_SCREEN_SHARE','MAX_WARNINGS_REACHED']);
